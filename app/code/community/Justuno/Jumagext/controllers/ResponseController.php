...
class Justuno_Jumagext_ResponseController extends Mage_Core_Controller_Front_Action
{
	...
	public function catalogFirstAction()
    {
    	$verifyUser = $this->authorizeUser();
    ...
    public function ordersAction()
    {
        ...
        if($verifyUser){
            ...
            //echo $ordersCollection->getSelect();//->__toString();
            //exit(0);
